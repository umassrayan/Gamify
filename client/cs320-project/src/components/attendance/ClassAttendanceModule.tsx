    ...
    return (
        <div className="class-attendance-module">
            ...
            <div className="controls" style={{ marginBottom: '15px' }}>
                <button onClick={fetchUserLocation} disabled={loadingUserLocation || isSubmitting} className="secondary-button">
            ...
            <div className="controls">
                {' '}
                {/* This div already exists, will center its content due to .class-attendance-module's text-align */}
                {/* ... buttons and status messages ... */}
                <button className="attendance-button" onClick={handleConfirmAttendance} disabled={isSubmitting || isAttendanceMarked || !isWithinRadius}>
