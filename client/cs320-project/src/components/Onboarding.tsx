...
const OnboardingFlow: React.FC = () => {
    ...
    const isDisabledStep2 = currentClassName.trim() === '' || currentClassLocation.trim() === '';
                ...
                <div style={styles.form}>
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <input type="number" value={numberOfClasses} onChange={handleNumberOfClassesChange} placeholder="e.g. 4" min="1" style={styles.input} />
                            <button
                                onClick={goToStep2}
                    ...
                    {step === 2 && typeof numberOfClasses === 'number' && (
                        <>
                            <h2 style={styles.inputText}>
                                Enter Details for Class {currentClassIndex + 1} of {numberOfClasses}
                            </h2>
                            <input type="text" placeholder="Class Name" value={currentClassName} onChange={(e) => setCurrentClassName(e.target.value)} style={styles.input} />
