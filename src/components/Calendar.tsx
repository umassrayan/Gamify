                    ...
                    return (
                        ...
                        >
                            <div style={{ marginBottom: '1rem' }}>
                                {date.getDate()} {date.toLocaleDateString(undefined, { weekday: 'short' })}
                            </div>
                            <div
                                style={{
                                    fontSize: '0.9rem',
                                ...
                                {[...(events[key] || [])]
                                    ...
                                    .map((event, idx) => (
                                        ...
                                        >
                                            ...
                                            <div style={{ fontStyle: 'italic', fontSize: '.8rem' }}>{event.title}</div>
                                        </div>
                                    ))}
                            </div>
                            <button
            ...
            {eventModalOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <input type="text" placeholder="Event Name" value={inputName} onChange={(e) => setInputName(e.target.value)} style={styles.input} />
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            <h1 style={styles.inputText}>Date</h1>
                            <input type="date" value={dateInput} onChange={(e) => setDateInput(e.target.value)} style={styles.input} />
                        </div>
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
